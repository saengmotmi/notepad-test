...
const client_id = "e6f5ce240b6b4db2af115f95ca585a8a"; // Your client id
const client_secret = "ee10466b2ae64195b22a74550279840f"; // Your secret
  ...
  return (
    <Container>
      <Form>
        ...
        >
          <g fillRule="evenodd" fill="#1db954">
        ...
        <a
          ...
          target="_blank"
        >
          <LoginBtn>Spotify로 로그인</LoginBtn>
        </a>
      </Form>
    </Container>
  );
